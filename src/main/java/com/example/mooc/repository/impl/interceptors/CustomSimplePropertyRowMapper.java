...
public class CustomSimplePropertyRowMapper<T> implements RowMapper<T> {
     ...
     */
    public CustomSimplePropertyRowMapper(Class<T> mappedClass) {
     ...
     */
    public CustomSimplePropertyRowMapper(Class<T> mappedClass, ConversionService conversionService) {
        ...
        for (int i = 0; i < args.length; i++) {
            ...
            try {
                ...
                try {
                    ...
                    // skip field to enable custom select
                    continue;
                }
            }
